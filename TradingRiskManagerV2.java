...
public class TradingRiskManagerV2 {
	...
	public static void main(String[] args) {
		...
		System.out.print("How many trades do you want to analyze?");
		int trades = input.nextInt();
		int totalRisk = 0;
		int approvedTrades = 0;
		int rejectedTrades = 0;
		for(int a = 1; a <= trades; a++)
		{
			System.out.println("\nTrade #" + a);
		...
		System.out.println("Approved Trades:" + approvedTrades);
		System.out.println("Rejected Trades:" + rejectedTrades);
